...
- **現在価格**: ${current:,.2f} ({change_pct:+.2f}%)"""
        ...
        st.markdown('<style>div[data-testid="stExpander"] {margin-top: -3.5rem !important;} .stExpander .streamlit-expanderHeader {font-size: 0.3rem !important;}</style>', unsafe_allow_html=True)
