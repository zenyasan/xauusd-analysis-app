...
def generate_advanced_analysis(style, current, change_pct, rsi, macd, macd_signal, atr, support, resistance, pivot, r1, s1, timeframe):
    ...
    """
        ...
        st.markdown("""
        <details>
            <summary style="font-size: 0.7rem; color: #ff5500; cursor: pointer; list-style: none;">ⓘ 用語解説</summary>
    ...
    """
        ...
        st.markdown("""
        <details>
            <summary style="font-size: 0.7rem; color: #00aaff; cursor: pointer; list-style: none;">ⓘ 用語解説</summary>
            <div style="font-size: 0.7rem; color: #00aaff; padding: 0.5rem 0 0.5rem 1rem; line-height: 1.5;">
